...
public sealed partial class TitleBarControl : Control
{
    ...
    protected override void OnApplyTemplate()
    {
        ...
        RootContainer = this.GetTemplateChild<Border>(nameof(RootContainer));
    }
    ...
    public async Task<bool> TryUpdateRegionsForCustomTitleBarAsync()
    {
        try
        {
            ...
            RootContainer.Height = CaptionButtonHeight;
    ...
    private void UpdateTitleAndIconVisibilityAndPosition()
    {
        ...
        AppTitleBarContainer.Visibility = DisplayOptions == TitleBarControlDisplayOptions.None ? Visibility.Collapsed : Visibility.Visible;

        AppIcon.Visibility = DisplayOptions.HasFlag(TitleBarControlDisplayOptions.Icon) ? Visibility.Visible : Visibility.Collapsed;

        AppTitleTextBlock.Visibility = DisplayOptions.HasFlag(TitleBarControlDisplayOptions.Title) ? Visibility.Visible : Visibility.Collapsed;
    }
